...
public class ArrayMaxOrMinElementSelection {
	...
	private static void thirdSmallest(int[] arr) {
		...
		for (int i : arr) {
			...
			/*
			 * If current element is smaller than first then update all 3 first, second and
			 * three
			 */
			if (i < first) {
				third = second;
		...
		System.out
				.println("The smallest: " + first + " , second Smallest: " + second + " and Third Smallest : " + third);
	...
	private static void thirddMax(int[] arr) {
		...
		System.out
				.println("The maximum element are First: " + first + " , second: " + second + " and Third : " + third);
	}
