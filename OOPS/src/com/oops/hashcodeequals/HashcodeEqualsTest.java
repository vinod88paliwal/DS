...
//If hashcode() not overridden means hashcode would be different (as comparing references) so it will store 2 objects of same type having same data in two buckets irrespective of equals() overridden or not.
