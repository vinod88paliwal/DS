 ...
 * inc = 5 exc = 0
 * 
 * For i = 1 (current element is 5) incl = (excl + arr[i]) = 5 excl = max(5, 0)
 * = 5
 * 
 * For i = 2 (current element is 10) incl = (excl + arr[i]) = 15 excl = max(5,
 * 5) = 5
 * 
 * For i = 3 (current element is 40) incl = (excl + arr[i]) = 45 excl = max(5,
 * 15) = 15
 * 
 * For i = 4 (current element is 50) incl = (excl + arr[i]) = 65 excl = max(45,
 * 15) = 45
 * 
 * For i = 5 (current element is 35) incl = (excl + arr[i]) = 80 excl = max(65,
 * 45) = 65
 * 
