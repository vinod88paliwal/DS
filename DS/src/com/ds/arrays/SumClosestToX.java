...
public class SumClosestToX {
	...
	static void minAbsSumPairCloseToX(int arr[], int n,int x)
	{
	   ...
	   // Initialize the diff between pair sum and x.
		  ...
		  // variable to keep track of the left and right pair for min_sum   
		     ...
		     // Arrays.sort(arr, l, r); --> Not required as question is for already sorted array
		      
		      while (l < r) {
		    	  
		   //If this pair is closer to x than the previously found closest, then update min_l,min_r and diff
	...
	static void minAbsSumPairCloseToX(int arr1[], int arr2[],int x)
	{
		...
		//First sort the arrays using merge sort if not sorted
		      ...
		      Arrays.sort(arr2, l, n2-1);*/ //--> Not required as Arrays are already sorted.
