...
public class LinkedListTest {
	...
	public static void main(String[] args) {
		...
		/*
		 * myList.add(60); myList.add(60); myList.add(50); myList.add(40);
		 * myList.add(40); myList.add(20); myList.add(20);
		 * 
		 * myList.DeleteDuplicates(); System.out.println(myList);
		 */
		...
		myList.add(40);
		myList.add(50);
		// myList.DeleteDuplicatesFromSortedlist();
		//System.out.println(myList);

		// myList.add(10); myList.add(10); myList.add(20); myList.add(20);
		// myList.add(30); myList.add(30); myList.add(40); myList.add(40);
		// myList.add(40);

		// myList.add(10); myList.add(8); myList.add(10); myList.add(3); myList.add(10);
		// myList.add(1);

		// myList.add(10); myList.add(8); myList.add(11); myList.add(3); myList.add(9);
		// myList.add(1);
		 ...
		 * 
		 * while (it.hasNext()) { Object obj = it.next(); //myList.add(50);
		 ...
		 * 
		 * l.add(10); l.add(20); //l.addFirst(30);
		 * 
		 * l.add(30); l.add(40); l.add(50); l.add(60); l.add(70); l.add(80);l.add(90);
		 * l.add(100);
		 * 
		 * //First Para : How many nodes to be traveled. //Second Para : Many nodes to
		 * be deleted. //l.deleteChoice(2, 3);
		 * 
		 * //l.add(250, 3); System.out.println(l);
		 * 
